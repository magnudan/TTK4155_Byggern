...
void CAN_init(void){
    ...
    MCP_bit_modify(MCP_RXB0CTRL, 0b01100000, 0x00);
...
int CAN_send(Can_block* can_block){
    MCP_bit_modify(MCP_TXB0CTRL, 0b00000011, 0x07);
...
Can_block CAN_recieve(uint8_t buffer){
    ...
    received_can_block.length = (MCP_read_single_data_byte(MCP_RXB0DLC)) & (0b00001111);
